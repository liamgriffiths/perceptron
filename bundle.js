...
"use strict";
var perceptron = require('../src/perceptron').perceptron;
function Points(n) {
  var $__0 = this;
              ...
              try {
                try {
                  ...
                  try {
                    ...
                    {
                      point = new RandomPoint(this.canvas.width, this.canvas.height);
                      this.points[i] = point;
                      answer = point.y > this.lineFn(point.x) ? 1 : 0;
...
Points.prototype = {
  ...
  drawPoints: function() {
    var $__0 = this;
    var count = this.frame % this.points.length;
    this.points.slice(0, count).forEach((function(point) {
      $__0.context.beginPath();
      $__0.context.arc(point.x, point.y, 10, 0, 2 * Math.PI, false);
      var guess = $__0.perceptron.predict([point.x, point.y]);
      if (guess > 0.5) {
        $__0.context.fillStyle = 'rgba(100, 100, 150, 0.2)';
        $__0.context.fill();
      } else {
        $__0.context.strokeStyle = 'rgba(100, 100, 150, 0.2)';
        $__0.context.stroke();
      }
    }));
  }
...
},{"../src/perceptron":4}],2:[function(require,module,exports){
...
var randomArray = (function(size) {
  return new (Function.prototype.bind.apply(Array, $traceurRuntime.spread([null], new Array(size))))().map((function(_) {
    return Math.random();
  }));
});
var step = (function(n) {
...
var perceptron = (function(size) {
  var activate = arguments[1] !== (void 0) ? arguments[1] : step;
  var alpha = arguments[2] !== (void 0) ? arguments[2] : 0.005;
  var $__0 = $traceurRuntime.assertObject(randomArray(size + 1)),
      bias = $__0[0],
      weights = Array.prototype.slice.call($__0, 1);
  var predict = (function(x) {
    return activate(x.reduce((function(acc, val, i) {
      return acc + weights[i] * val;
    }), bias));
  });
  var train = (function(x, y) {
    var error = y - predict(x);
    bias += error * alpha;
